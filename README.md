...
![Trivium — open-source website audits for the AI-search era](media/trivium_hero.gif)
...
- [Trivium](#trivium)
  ...
  - [The Three Pillars](#the-three-pillars)
    - [🔧 Grammar — Technical SEO (29 checks)](#-grammar--technical-seo-29-checks)
    - [🤖 Logic — LLM Readiness (19 checks)](#-logic--llm-readiness-19-checks)
    - [🎯 Rhetoric — Marketing Effectiveness (20 checks)](#-rhetoric--marketing-effectiveness-20-checks)
  - [Features](#features)
  ...
  - [Security](#security)
  - [License](#license)
    - [What AGPL-3.0 means in practice](#what-agpl-30-means-in-practice)
